	...
	{Repeat = 0,  --infinite
		...
		{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_82nd_demo_late_irr(usa)"},
			...
			-- Doctrine Point Units 
				...
				--  All-round Doctrine
					---[[
					{priority = 1.0, type = {"Class2", "Tier1", "Armored", "AA",}, unit = "m16_mgmc"},
					--{priority = 1.0, type = {"Class3", "Doctrine", "Tier1", "Armored", "Mortar",}, unit = "doctrine_m4a1_mortar_carrier_late"},
					{priority = 1.0, type = {"Class2", "Tier1", "Cannon", "Support",}, unit = "75mm_m3a3"},

					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Medium", "Support",}, unit = "m4a3_105_hvss"},
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier2", "Infantry", "Team",}, unit = "doctrine_squad_usa_signaller_155_late(usa)"},
					{priority = 1.0, type = {"Class1", "Tier2", "Tank", "Medium", "Artillery",}, unit = "m7b1_hmc"},
					
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier3", "Infantry", "Team",}, unit = "doctrine_squad_usa_signaller_240_late(usa)"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Heavy",}, unit = "m26_pershing"},
					{priority = 1.0, type = {"Class2", "Tier3", "Tank", "Medium", "Artillery",}, unit = "m12_gmc"},
					--]]

				--  Defensive Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier1", "Vehicle", "MG", "Support", "Engineer",}, unit = "doctrine_cckw_engineer_late"},
					{priority = 1.0, type = {"Class3", "Tier1", "Cannon", "AA",}, unit = "40mm_m1"},
					{priority = 1.0, type = {"Class2", "Tier1", "Armored", "AT",}, unit = "m3a1_gmc"},
					
					{priority = 1.0, type = {"Class2", "Tier2", "Cannon", "Mortar",}, unit = "107mm_m2"},
					{priority = 1.0, type = {"Class1", "Tier2", "Cannon", "AA", "AT",}, unit = "90mm_m1a1"},
					{priority = 1.0, type = {"Class3", "Tier2", "Armored", "Artillery",}, unit = "t19_hmc"},
					
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Medium", "AT",}, unit = "m36b1_gmc_t33"},
					{priority = 1.0, type = {"Class3", "Tier3", "Cannon", "Artillery",}, unit = "203mm_m1"},
					{priority = 1.0, type = {"Class1", "Tier3", "Cannon", "Artillery", "AT",}, unit = "155mm_m1a1_longtom"},
					--]]

				--  Irregular Doctrine
					---[[
					--{priority = 1.0, type = {"Class3", "Tier1", "Infantry",}, unit = "doctrine_squad_1st_special_late(usa)"},
					{priority = 1.0, type = {"Class2", "Tier1", "Cannon", "Support",}, unit = "75mm_m1a1"},
					...
					{priority = 1.0, type = {"Class1", "Tier2", "Tank", "Medium", "AT",}, unit = "m4a3_75w_e4_5"},
					{priority = 1.0, type = {"Class2", "Tier2", "Cannon", "Artillery",}, unit = "105mm_m3"},

					--{priority = 1.0, type = {"Class", "Doctrine", "Tier3", "Plane", "Airstrike",}, unit = "doctrine_p47_500_late"},
					{priority = 1.0, type = {"Class3", "Tier3", "Cannon", "Artillery",}, unit = "114mm_m1"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Medium", "Artillery",}, unit = "m4a3_calliope"},
					--]]

				--  Offensive Doctrine
					---[[
					{priority = 1.0, type = {"Class3", "Tier1", "Armored", "MG",}, unit = "m3a1_commander"},
					{priority = 1.0, type = {"Class2", "Tier1", "Armored", "AA",}, unit = "m15a1_cgmc"},
					{priority = 1.0, type = {"Class1", "Tier1", "Tank", "Light", "Support",}, unit = "m8_hmc"},

					{priority = 1.0, type = {"Class3", "Tier2", "Tank", "Light", "AT",}, unit = "m18_hellcat_late"},
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Medium",}, unit = "m4a3_76w_field3"},
					...
					{priority = 1.0, type = {"Class3", "Tier3", "Cannon", "Artillery",}, unit = "155mm_m1"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Heavy",}, unit = "t26e4"},
					--]]
		}
	}
}