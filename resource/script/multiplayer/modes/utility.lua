...
-- Called OnGameStart()
function OnGameStartUtility(purchasesModuleSuffix,purchasesBotArmy)
    print("Print: AI Bot is player#" .. BotApi.Instance.playerId .. ", nation " .. purchasesBotArmy .. ", on team " .. team .. " which has " .. teamSize .. " player(s)")
    ...
    local purchasesModule = [[/script/multiplayer/units/]] .. purchasesBotArmy .. "/" .. purchasesModuleSuffix .. "." .. purchasesBotArmy
    ...
    -- Get purchases
    local purchases = Purchases[purchasesModuleSuffix .. "." .. purchasesBotArmy]
