	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Doctrine All Around = "Guerilla Warfare"
				---[[
				{priority = 1.0, type = {"Doctine", "Cannon", "Mortar", "Tier1", "Class3",}, unit = "50mm_krh38"},
				{priority = 1.0, type = {"Doctine", "Vehicle", "AA", "Tier1", "Class1",}, unit = "ford_3ton_breda"},
				{priority = 1.0, type = {"Doctine", "Tier1", "Class3",}, unit = "squad_border_guard_early(fin)"},

				{priority = 1.0, type = {"Doctine", "Cannon", "Support", "Tier2", "Class1",}, unit = "76mm_m1927_fin"},
				{priority = 1.0, type = {"Doctine", "Cannon", "AT", "Tier2", "Class1",}, unit = "76mm_k02_30_40"},
				--{priority = 1.0, type = {"Doctine", "Infantry", "Team", "Tier2", "Class4",}, unit = "doctrine_squad_signaller_early(fin)"},

				{priority = 1.0, type = {"Doctine", "Cannon", "Artillery", "Tier3", "Class3",}, unit = "155mm_h17"},
				--]]

			-- Doctrine Defensive = "Mannerheim Line"
				---[[
				{priority = 1.0, type = {"Doctine", "Tier1",}, unit = "doctrine_squad_engineer_early(fin)"},
				{priority = 1.0, type = {"Doctine", "Cannon", "AT", "Tier1",}, unit = "45mm_pstk32"},
			...
			-- Doctrine Irregular = "Special Operations"
				...
				{priority = 1.0, type = {"Doctine", "Tier1",}, unit = ""},
				...
				{priority = 1.0, type = {"Doctine", "Tank", "Light", "Tier2",}, unit = "kht130_fin"},
			...
			-- Doctrine Offensive = "Motti Assault"
				...
				{priority = 1.0, type = {"Doctine", "Tank", "Light", "Tier1",}, unit = "47mm_pstk39"}, 
				{priority = 1.0, type = {"Doctine", "Tank", "Light", "Tier1",}, unit = "t26e"},

				{priority = 1.0, type = {"Doctine", "Tier2",}, unit = "doctrine_motorised_jaegers_early"},
				{priority = 1.0, type = {"Doctine", "Tank", "Medium", "Tier2",}, unit = "84mm_k18"},
				{priority = 1.0, type = {"Doctine", "Tank", "Medium", "Tier2",}, unit = "t28_38_fin"},

				{priority = 1.0, type = {"Doctine", "Cannon", "Artillery", "Tier3",}, unit = "170mm_minewerfer"},
