	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Doctrine All Around = "Guards Unit"
				---[[
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "bt2_da2"},
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_mountainrifles(rus)"},
				{priority = 1.0, type = { "Cannon", "AT", "Class1",}, unit = "76mm_f22"},

				--{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_guards_mid(rus)"},
				{priority = 1.0, type = { "Tank", "Medium", "Class2",}, unit = "t3457_41"},
				--{priority = 1.0, type = { "Class2", "Class4",}, unit = "doctrine_squad_rus_signaller_mid(rus)"},

				{priority = 1.0, type = { "Tank", "Heavy", "Class3",}, unit = "kv1_41"},
				{priority = 1.0, type = { "Tank", "Heavy", "AT", "Class3",}, unit = "su100y"},
				--]]

			-- Doctrine Defensive = "Not One Step Back!"
				---[[
				{priority = 1.0, type = { "Cannon", "MG", "Class1",}, unit = "dshk_aa"},
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_t26"},
				{priority = 1.0, type = { "Cannon", "AT", "Class1",}, unit = "45mm_m42"},
			...
			-- Doctrine Irregular = "Reserves"
				---[[
				{priority = 1.0, type = { "Cannon", "Class1",}, unit = "m41_ampulomet"},
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_spetsnaz_mid(rus)"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "bt7a"},

				{priority = 1.0, type = { "Tank", "Light", "Class2",}, unit = "kht130"},
				{priority = 1.0, type = { "Tank", "Light", "AT", "Class2",}, unit = "zis30"},
				{priority = 1.0, type = { "Tank", "Medium", "Class2",}, unit = "t3476_43_flame"},

				--{priority = 1.0, type = { "Plane", "Airstrike", "Class3",}, unit = "doctrine_il2_mid"},
			...
			-- Doctrine Offensive = "Spearheard"
				---[[
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_smgunit(rus)"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "bt2"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "t60"},

				--{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_penal(rus)"},
				--{priority = 1.0, type = { "Cannon", "AT", "Class2",}, unit = "doctrine_mechanized"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class2",}, unit = "kv1s"},

				--{priority = 1.0, type = { "Tank", "Medium", "Class3",}, unit = "doctrine_tankodesantniki"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class3",}, unit = "kv2_40"},
				--]]

			-- Doctrine Support = "Stalin Line"
				---[[
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_rus_politicalofficer_mid(rus)"},
				{priority = 1.0, type = { "Tank", "Light", "Support", "Class1",}, unit = "su26"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class1",}, unit = "t35_late"},

				--{priority = 1.0, type = { "Plane", "Recon", "Class2",}, unit = "doctrine_po2_mid"},
