	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Doctrine All Around = "Lend-lease"
				---[[
				{priority = 1.0, type = { "Armored", "MG", "Class1",}, unit = "mmg_carrier_rus"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "m3_stuart_late_rus"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "valentine7"},

				--{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_scoutcar_marines"},
				{priority = 1.0, type = { "Tank", "Medium", "Class2",}, unit = "m4a2_75_late_rus"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class2",}, unit = "churchill3"},

				--{priority = 1.0, type = { "Cannon", "AT", "Class3", "Class3",}, unit = "doctrine_100mm_bs3_scoutcar"}, --towed
				{priority = 1.0, type = { "Tank", "Medium", "Class3",}, unit = "m4a2_76w_early_rus"},
				--{priority = 1.0, type = {"Vehicle", "Artillery", "Class3", "Class4",}, unit = "doctrine_bm31"},
				--]]

			-- Doctrine Defensive = "Breakthrough"
				---[[
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_sapperteam(rus)"},
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_rifle_motorised"},
				{priority = 1.0, type = { "Cannon", "Support", "Class1",}, unit = "76mm_m43"},

				--{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_heavymarines(rus)"},
				{priority = 1.0, type = { "Cannon", "Mortar", "Class2",}, unit = "120mm_pm38"},
				{priority = 1.0, type = { "Cannon", "AA", "AT", "Class2",}, unit = "85mm_52k"},

				{priority = 1.0, type = { "Cannon", "Artillery", "Class3",}, unit = "152mm_ml20"},
				{priority = 1.0, type = { "Tank", "Medium", "AT", "Class3",}, unit = "su100"},
				{priority = 1.0, type = { "Cannon", "Artillery", "Class3",}, unit = "203mm_b4"},
				--]]

			-- Doctrine Irregular = "Demolition"
				---[[
				{priority = 1.0, type = { "Cannon", "MG", "Class1",}, unit = "dshk_aa"},
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_spetsnaz_late(rus)"}, --TODO: Causes Crash, unknown.
				{priority = 1.0, type = { "Cannon", "AA", "Class1",}, unit = "37mm_61k"},

				{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_heavyrecon(rus)"},
				{priority = 1.0, type = { "Tank", "Medium", "Class2",}, unit = "t3476_43_flame"},
				{priority = 1.0, type = { "Tank", "Medium", "Class2",}, unit = "t3457_43"},

				--{priority = 1.0, type = { "Plane", "Airstrike", "Class3",}, unit = "doctrine_il2_late"},
				{priority = 1.0, type = { "Tank", "Heavy", "AT", "Class3",}, unit = "isu122s"},
				{priority = 1.0, type = { "Vehicle", "Artillery", "Class3",}, unit = "bm13_studebaker"},
				--]]

			-- Doctrine Offensive = "Shock Army"
				---[[
				--{priority = 1.0, type = { "Class1",}, unit = "doctrine_squad_faustniki(rus)"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "t60"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "t70m"},

				--{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_flame(rus)"},
				--{priority = 1.0, type = { "Class2",}, unit = "doctrine_squad_rus_signaller_late(rus)"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class2",}, unit = "kv85"},

				{priority = 1.0, type = { "Tank", "Medium", "Class3",}, unit = "t3485_44"},
				{priority = 1.0, type = { "Tank", "Heavy", "AT", "Class3",}, unit = "isu152"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class3",}, unit = "is2_44"},
				--]]

			-- Doctrine Support = "Iron Curtain"
				---[[
				--{priority = 1.0, type = { "Infantry", "Team", "Class1",}, unit = "doctrine_squad_rus_politicalofficer_late(rus)"},
				--{priority = 1.0, type = { "Vehicle", "MG", "Infantry", "Team", "Class1",}, unit = "doctrine_m72_snipers_late"},
				{priority = 1.0, type = { "Tank", "Light", "Class1",}, unit = "t50"},

				--{priority = 1.0, type = { "Plane", "Recon", "Class2",}, unit = "doctrine_po2_late"},
				{priority = 1.0, type = { "Tank", "Medium", "Class2",}, unit = "t3485_44b"},
				{priority = 1.0, type = { "Tank", "Medium", "AT", "Class2",}, unit = "su85m"},

				{priority = 1.0, type = { "Tank", "Medium", "Class3",}, unit = "t3485_44a_flame"},
				{priority = 1.0, type = { "Tank", "Heavy", "Class3",}, unit = "is2_45"},
