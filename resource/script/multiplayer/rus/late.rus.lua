	...
	{Repeat = 0,  --infinite
		...
		-- Infantry Squads
			...
			-- Doctrine Point Units 
				...
				--  All-round Doctrine
					---[[
					{priority = 1.0, type = {"Class3", "Tier1", "Armored", "MG",}, unit = "ba20_command"},
					{priority = 1.0, type = {"Class2", "Tier1", "Tank", "Light",}, unit = "t60"},
					{priority = 1.0, type = {"Class1", "Tier1", "Tank", "Light",}, unit = "t70m"},

					--{priority = 1.0, type = {"Class", "Doctrine", "Tier2", "Infantry",}, unit = "doctrine_squad_rus_signaller_late(rus)"},
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Light", "Artillery",}, unit = "t60_bm8_24"},
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Heavy",}, unit = "kv85"},
													   
					{priority = 1.0, type = {"Class2", "Tier3", "Cannon", "Artillery",}, unit = "122mm_a19"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Heavy", "AT",}, unit = "isu152"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Heavy",}, unit = "is2_44"},
					--]]

				--  Defensive Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier1", "Infantry",}, unit = "doctrine_squad_sapper_motorised_late(rus)"},
					{priority = 1.0, type = {"Class3", "Tier1", "Cannon", "AA",}, unit = "37mm_61k"},
					{priority = 1.0, type = {"Class2", "Tier1", "Cannon", "Support",}, unit = "76mm_m43"},

					{priority = 1.0, type = {"Class2", "Tier2", "Cannon", "Mortar",}, unit = "120mm_pm38"},
					{priority = 1.0, type = {"Class2", "Tier2", "Vehicle", "Artillery",}, unit = "zis6_bm8_48"},
					{priority = 1.0, type = {"Class2", "Tier2", "Cannon", "AA", "AT",}, unit = "85mm_52k"},

					{priority = 1.0, type = {"Class1", "Tier3", "Cannon", "Artillery",}, unit = "152mm_ml20"},
					{priority = 1.0, type = {"Class3", "Tier3", "Cannon", "Artillery",}, unit = "203mm_b4"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Medium", "AT",}, unit = "su100"},
					--]]
				...
				--  Irregular Doctrine
					...
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Medium",}, unit = "t3457_43"},
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Medium",}, unit = "t3476_43_flame"},
					...
					{priority = 1.0, type = {"Class2", "Tier3", "Cannon", "Artillery",}, unit = "300mm_m31"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Heavy", "AT",}, unit = "isu122s"},
					--]]
				...
				--  Lend-Lease Doctrine
					...
					{priority = 1.0, type = {"Class3", "Tier2", "Cannon", "Artillery",}, unit = "107mm_m1910_30"},

					--{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Medium",}, unit = "doctrine_2m4a2_76_rus"},
					{priority = 1.0, type = {"Class2", "Tier3", "Vehicle", "Artillery",}, unit = "bm31_12"},
					{priority = 1.0, type = {"Class1", "Tier3", "Cannon", "AT",}, unit = "100mm_bs3"},
					--]]

				--  Support Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Tier1", "Infantry", "Team",}, unit = "doctrine_squad_rus_politicalofficer_late(rus)"},
					{priority = 1.0, type = {"Class3", "Tier1", "Tank", "Light", "Support",}, unit = "bt7a"},
					--{priority = 1.0, type = {"Class2", "Tier1", "Tank", "Light",}, unit = "t50"},

					--{priority = 1.0, type = {"Class", "Tier2", "Plane", "Recon",}, unit = "doctrine_po2_late"},
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Medium", "AT",}, unit = "su85m"},
					{priority = 1.0, type = {"Class2", "Tier2", "Tank", "Medium",}, unit = "t3485_44b"},

					{priority = 1.0, type = {"Class2", "Tier3", "Vehicle", "Artillery",}, unit = "bm13_studebaker"},
					{priority = 1.0, type = {"Class1", "Tier3", "Cannon", "Artillery",}, unit = "280mm_br5"},
					{priority = 1.0, type = {"Class1", "Tier3", "Tank", "Heavy",}, unit = "is2_45"},
					--]]
